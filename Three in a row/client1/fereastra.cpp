...
//---------------------------------------------------------------------------
__fastcall Tplayer1::Tplayer1(TComponent* Owner)
        : TForm(Owner)
{   arata=new PUC(10,10);
//da eroare  daca nu ii dau nr pt linie si col  din cauza la MouveMouse la fereastra
nrvictoriip1=0;
       nrvictoriip2=0;
       SchimbaOrdinea=true;
...
//---------------------------------------------------------------------------
void __fastcall Tplayer1::btnStartClick(TObject *Sender)
{
 btnStartAFostApasat=true;
 player1->Socket->SendText("START1");
}
//---------------------------------------------------------------------------

void __fastcall Tplayer1::cl1Click(TObject *Sender)
{
  ojoc->DisparePuculUndeOSaCadaLaClick(casuta,arata);
if(ojoc->player1G==true)
   player1->Socket->SendText("btn1");
}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::cl2Click(TObject *Sender)
{
 ojoc->DisparePuculUndeOSaCadaLaClick(casuta,arata);
if(ojoc->player1G==true)
   player1->Socket->SendText("btn2");
}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::cl3Click(TObject *Sender)
{
ojoc->DisparePuculUndeOSaCadaLaClick(casuta,arata);
if(ojoc->player1G==true)
   player1->Socket->SendText("btn3");

}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::cl4Click(TObject *Sender)
{
ojoc->DisparePuculUndeOSaCadaLaClick(casuta,arata);
if(ojoc->player1G==true)
   player1->Socket->SendText("btn4");
}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::cl5Click(TObject *Sender)
{
ojoc->DisparePuculUndeOSaCadaLaClick(casuta,arata);
if(ojoc->player1G==true)
   player1->Socket->SendText("btn5");
}
 //---------------------------------------------------------------------------
void __fastcall Tplayer1::btnContinuaClick(TObject *Sender)
{
   textW->Visible=false;
   player1->Socket->SendText("continua1");
   LabelContinua->Visible=true;
   btnContinua->Visible=false;
   LabelContinua->Caption="Asteptati raspunsul adversarului";
}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::btnExitClick(TObject *Sender)
{
player1->Socket->SendText("exit");
}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::timpTimer(TObject *Sender)
{
   cadere(ojoc->getLinie(),ojoc->getColoana());
}
//---------------------------------------------------------------------------

void __fastcall Tplayer1::FormResize(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall Tplayer1::player1Read(TObject *Sender,
      TCustomWinSocket *Socket)
{
  ...
  if(str=="START1")
    {
       btnStart->Caption="Asteptati";
    }

}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::btnAcceptClick(TObject *Sender)
{
   player1->Socket->SendText("accept");
}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::cl1MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
if(ojoc->player1G&&timp->Enabled==false)
   //cand apesi pe buton si dupa misti rpd mousu pe alt buton  o sa arte acolo ca pica si
   // ramne asa pana la urmatorul rand, asta rezolsva timp==false
    {
        ...
        AfCuloareLaMouseMove("olive");
    }
}
//---------------------------------------------------------------------------
void __fastcall Tplayer1::cl2MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
if(ojoc->player1G&&timp->Enabled==false)
    {
...
//---------------------------------------------------------------------------
void __fastcall Tplayer1::cl3MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
if(ojoc->player1G&&timp->Enabled==false)
 {
...
void __fastcall Tplayer1::cl4MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
if(ojoc->player1G&&timp->Enabled==false)
 {
...
void __fastcall Tplayer1::cl5MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
if(ojoc->player1G&&timp->Enabled==false)
{
...
//---------------------------------------------------------------------------
void __fastcall Tplayer1::FormMouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
if(btnStartAFostApasat)
    AfCuloareLaMouseMove("alb");
...
void __fastcall Tplayer1::casutaMouseMove(TObject *Sender,
...
void Tplayer1::AfCuloareLaMouseMove(String culoare)
   {
          TRect r;
 ...
 //---------------------------------------------------------------------------
void  Tplayer1::ResetTot()
{
delete ojoc;
textW->Caption="Este randul tau(galben)";
textW->Font->Size=20;
...
//---------------------------------------------------------------------------
void Tplayer1::DacaCinevaCastiga()
{
   textW->Font->Size=40;
...
//---------------------------------------------------------------------------
void Tplayer1::cadere(int linie,int col)
{
  arata=new PUC(10,10);
     if(linie!=0)
       {
